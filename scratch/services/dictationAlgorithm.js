...
exports.DictationAlgorithm = void 0;
class DictationAlgorithm {
     ...
     */
    static extractSpanishVariants(targetText) {
     ...
     */
    static evaluate(userInput, targetText, isSpanishTarget = false, acceptedTranslations) {
...
exports.DictationAlgorithm = DictationAlgorithm;
